...
'SetText': ['', 
'むせ返る化粧【ケショウ】と香【コウ】、美しい衣【コロモ】を纏った【マトった】女官【ニョカン】の唇【クチビル】には薄っぺらい笑みが張り付いていた。',
'薬屋をやってきて思うこと、女の笑みほど恐ろしい毒はないと。',
'それは殿上人の住まう御殿も城下の花街も変わらないのだと。',

'足元に置いた洗濯籠を抱え、建物の奥に向かう。表とは違い、殺風景な中庭には石畳の水場があり、男とも女ともつかない召使たちが大量の洗濯物を洗っていた。',
'後宮は基本男子禁制である。入れるのは、国で最も高貴なかたとその血縁、あと大切なものを失った元男性だけである。もちろん、そこにいるのは後者である。',
'歪だと思いつつ、それが利にかなっているからやっていることなのだろうと猫猫は考える。',
'籠を置くと、そばの建物の中にある並べられた籠を見る。汚れ物ではなく、日の当たった洗濯済みのものだ。',
'持ち手にかけられた木札を見る。植物を模した絵と数字が書かれている。',
'',
'女官の中には字が読めないものもいる、なんせ人さらいのごとく攫われたものさえいるのだから。宮廷に連れ込まれる前に最低限の礼儀くらいは教えられるが、文字となると難しい。識字率は田舎の娘で半分越せばいいほうなのである。',
'',
'大きくなり過ぎた後宮の弊害といえる、量は増えたが質が悪い。',
'先帝の花の園には到底及ばないものの、妃、女官合わせて二千人、宦官を加えると三千の大所帯だった。',
'',
'猫猫はその中で最下層の下女であり、官職すらもらっていない。特に後ろ盾もなく、攫われて数合わせにされた娘にはそれが妥当なところである。まあ、牡丹のような豊満な肉体や、満月のような白い肌でも持っていればまだ、下妃の位につける可能性もあったかもしれないが、猫猫の持つのはそばかすの浮いた健康的な肌と枯れ枝のような手足くらいである。',
'',
'（はやく仕事終わらせよう）',
'',
