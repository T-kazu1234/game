...
dbscene = {
  ...
  'SetNextSceneName':'scene8'//デバッグモード用▷一気に指定シーンへ移動する
}
...
scenechange1 = {
    'SetBackGroundImage_fadeIN': "BackGround_01_00.png",//背景単色_黒
    'SetText': ['',
    ''
    ],
 'SetNextSceneName':'scene5'
...
scene5 = {
'SetBackGroundImage': "BackGround_06_00.png",//洗い場
'DeleteCharactor':"",
'SetText': ['',
//***区切り********************************************************
...
///*
scene8 = {
  'SetChoiceScene': [" ▶︎近頃の噂話について思いを馳せる","scene18"," ▶︎汁物をすすりながら猫猫は耳を傾ける。","scene9"],
}
//*/
...
scene18B = {
  'SetChoiceScene': [" ▶死因について","scene11"," ▶︎状況は？","scene8"],
}
...
//梨花妃の白い肌
梨花リファ妃と侍女たちは真っ白なおしろいをふんだんに使っていた。庶民には手を出せない高級品だ。


//妓楼に蔓延る毒
それは妓楼ぎろうの高級遊女たちも使っていた。一晩で農民一生分の銀を稼ぐ妓女ぎじょもいる、自分で買うものもいれば、貢物プレゼントにもらうものもいた。
顔から首にかけて真っ白にはたかれるそれは、妓女の身体を蝕むしばみ、幾人かを死に至らしめた。
やせ細り、衰弱して死んでいく妓女を猫猫はおやじのそばで幾人も見てきた。
命と美貌を天秤にかけ、結局どちらも失ったのだ。
...
scene12 = {
    ...
    //***区切り********************************************************
    '玉葉妃',
    '西方の血を色濃く継ぐ玉葉妃は、赤い髪に翡翠の瞳｜ヒスイのヒトミ｜を持ち、元々透通る様な白い肌をしている。<そのため妃達の間で重宝されているおしろいは使用していないようだ。',
    'その美しさから帝のご寵愛は玉葉妃に傾いているらしい・・・',
    //***区切り********************************************************
    '梨花妃',
    '息子と同じ病に侵されているとの噂は本当のようで、大輪の薔薇といわれた頃の面影はなかった。',
    '肌の調子をごまかす様に顔色が悪いのをごまかすように塗りたくっていた。',
    'だがしかし、皮肉なもので幽鬼の様な白い肌はかえって病状の酷さを物語っている。',
    //***区切り********************************************************
    'POINT!',
    '玉葉妃はおしろいを使用しておらず、梨花妃はおしろいを使用している。',
    'この点は重要だろうか？'
    //***区切り********************************************************
    ],
    'SetCharactorLeft': 'think_item_00.png',
    'SetNextSceneName': 'HINTscene_Check01'
    }
...
//気づきをセットする
HINTscene_Check01 = {
    'SetChoiceScene': [" ▶︎気に留めておこう。", "HINTscene_set", " ▶︎いや、さほど問題ではないであろう。", "scene9"],
}
...
console.log('HINTscene_set:"SetCharactorLeft": =' + this);
