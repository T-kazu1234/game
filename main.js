...
window.onload = function(){
    ...
    core.onload = function(){
        ...
        //地面の設定
        var zimen1 = new Sprite(600,4000);
        ...
        function zimen(name){
            ...
            if(name.intersect(serval)){
                if(serval.x > name.x-400){
                    if(serval.x < name.x-300){
            ...
            if(name.intersect(cerulean)){
                if(cerulean.x > name.x-308){
                    if(cerulean.x < name.x-208){
                        time_cerulean = 0;
                        syosoku_cerulean = -spead_cerulean*0.2;//反射係数
                        spead_cerulean = 0;
                        cerulean.x = name.x-308;
                    };
                };
                if(cerulean.x > name.x-208){
                    cerulean.y = name.y-331;
                };
            };//セルリアンここまで
        ...
        //サーバルちゃんの動作設定
        serval.addEventListener('enterframe',function(){this.rotation=-90;
        ...
        zimen2.addEventListener('enterframe',function(){this.rotation=-90;
                                zimen(this);
                                });//地面2
        //地面の動作設定ここまで
        
        //かばんちゃんの動作設定
        bag.addEventListener('enterframe',function(){this.rotation=-90;
                             if(this.intersect(serval)){
                             if(serval.x < this.x-300){
                             game_clear_2.x=0;
                             replay.x = 0;
                             };
                             jump=-100;
        ...
        //トキさんの動作設定
        toki.addEventListener('enterframe',function(){this.rotation=-90;
                              if(jump==2){
                                if(this.intersect(serval)){
                                    if(this.y>180){
                                        serval.y=this.y-180;
        ...
        //セルリアンの動作設定
        cerulean.addEventListener('enterframe',function(){this.rotation=-90;
                                  
                                  this.x -= spead_cerulean;
        ...
        //ジャパリコインの動作設定
        japaricoin.addEventListener('enterframe',function(){this.rotation=-90;
                             if(this.intersect(serval)){
                             this.y = -500;
                             kill += 10;
                             };
        ...
        //リプレイボタンの動作設定
        replay.addEventListener('enterframe',function(){this.rotation=-90;
