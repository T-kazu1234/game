 ...
 *
 * íòçÏå†UEIäîéÆâÔé–
 * MITÉâÉCÉZÉìÉXÇ≈ÉäÉäÅ[ÉXÇ≥ÇÍÇ‹ÇµÇΩÅB
 */
...
/**
 *ÉâÉCÉuÉâÉäÉNÉâÉXÇÉOÉçÅ[ÉoÉãÇ…ÉGÉNÉXÉ|Å[ÉgÇµÇ‹Ç∑ÅB
 *
 *à¯êîÇ™éwíËÇ≥ÇÍÇƒÇ¢Ç»Ç¢èÍçáÅAenchant.jsÇ≈íËã`Ç≥ÇÍÇƒÇ¢ÇÈÇ∑Ç◊ÇƒÇÃÉNÉâÉXÅAÇ®ÇÊÇ—
 *ÉvÉâÉOÉCÉìÇ™ÉGÉNÉXÉ|Å[ÉgÇ≥ÇÍÇ‹Ç∑ÅBï°êîÇÃà¯êîÇ™éwíËÇ≥ÇÍÇΩèÍçáÅAÉfÉtÉHÉãÉgÇ≈íËã`Ç≥ÇÍÇƒÇ¢ÇÈÉNÉâÉX
 * in enchant.jsÇ™ÉGÉNÉXÉ|Å[ÉgÇ≥ÇÍÇ‹Ç∑ÅBÉvÉâÉOÉCÉìÉNÉâÉXÇÉGÉNÉXÉ|Å[ÉgÇ∑ÇÈèÍçáÇÕÅAñæé¶ìIÇ…îzêMÇ∑ÇÈïKóvÇ™Ç†ÇËÇ‹Ç∑
 *à¯êîÇ∆ÇµÇƒÇÃÉvÉâÉOÉCÉìéØï éqÅB
 *
 * @example
 * enchant();   //Ç∑Ç◊ÇƒÇÃÉNÉâÉXÇ™ÉGÉNÉXÉ|Å[ÉgÇ≥ÇÍÇ‹Ç∑ÅB
 * enchant(''); // enchant.jsÇÃÉNÉâÉXÇæÇØÇ™ÉGÉNÉXÉ|Å[ÉgÇ≥ÇÍÇ‹Ç∑ÅB
 * enchant('ui');  // enchant.jsÉNÉâÉXÇ∆ui.enchant.jsÉNÉâÉXÇ™ÉGÉNÉXÉ|Å[ÉgÇ≥ÇÍÇ‹Ç∑ÅB
 *
 * @param {... String} [modules]ÉÇÉWÉÖÅ[ÉãÇÉGÉNÉXÉ|Å[ÉgÇµÇ‹Ç∑ÅBï°êîÇÃéwíËÇ™â¬î\Ç≈Ç∑ÅB
 * @ä÷êî
 * @ÉOÉçÅ[ÉoÉã
 * @nameÉGÉìÉ`ÉÉÉìÉg
 */
...
/**
* åpè≥ÇÉTÉ|Å[ÉgÇ∑ÇÈÉNÉâÉXÇï\Ç∑ÉNÉâÉXÅB
* @param {ä÷êî} [ÉXÅ[ÉpÅ[ÉNÉâÉX]
*  êVÇµÇ¢ÉNÉâÉXÇÕÉNÉâÉXíËã`Çåpè≥ÇµÇ‹Ç∑ÅB
* @param {*} [íËã`]ÉNÉâÉXíËã`ÅB
* @constructor
*/
...
/**
* ÉNÉâÉXÇçÏê¨ÇµÇ‹Ç∑ÅB
*
* ï ÇÃÉNÉâÉXÇ©ÇÁåpè≥ÇµÇΩÉNÉâÉXÇíËã`Ç∑ÇÈèÍçáÅA
* ÉfÉtÉHÉãÉgÇ≈ÇÕÅAëºÇÃÉNÉâÉXÇÃÉRÉìÉXÉgÉâÉNÉ^Ç™égópÇ≥ÇÍÇ‹Ç∑ÅB
* Ç±ÇÃÉRÉìÉXÉgÉâÉNÉ^ÇÉIÅ[ÉoÅ[ÉâÉCÉhÇµÇƒÇ‡ÅAÇªÇÍÇåƒÇ—èoÇ∑ïKóvÇ™Ç†ÇËÇ‹Ç∑
* ÉNÉâÉXÇ™ê≥ÇµÇ≠èâä˙âªÇ≥ÇÍÇÈÇÊÇ§Ç…ÇµÇ‹Ç∑ÅB
*
* @example
*// BallÉNÉâÉXÇçÏê¨ÇµÇ‹Ç∑ÅB
* var Ball = Class.createÅi{
*
* //É{Å[ÉãÇÃÉRÉìÉXÉgÉâÉNÉ^
* èâä˙âªÅFä÷êîÅiîºåaÅj{
* // ...ÉRÅ[Éh...
* }ÅA
*
* //à¯êîÇéÊÇÁÇ»Ç¢fallÉÅÉ\ÉbÉhÇíËã`ÇµÇ‹Ç∑ÅB
* fallÅFfunctionÅiÅj{
* // ...ÉRÅ[Éh...
* }
* }Åj;
*
* // "Sprite"Ç©ÇÁåpè≥Ç∑ÇÈBallÉNÉâÉXÇçÏê¨ÇµÇ‹Ç∑ÅB
* var Ball = Class.createÅiÉXÉvÉâÉCÉgÅj;
*
* // "Sprite"Ç©ÇÁåpè≥Ç∑ÇÈBallÉNÉâÉXÇçÏê¨ÇµÇ‹Ç∑ÅB
* var Ball = Class.createÅiÉXÉvÉâÉCÉgÅA{
*
* //ÉXÉvÉâÉCÉgÇÃÉRÉìÉXÉgÉâÉNÉ^Çè„èëÇ´Ç∑ÇÈ
*èâä˙âªÅFä÷êîÅiîºåaÅj{
*
* //ÉXÉvÉâÉCÉgÇÃÉRÉìÉXÉgÉâÉNÉ^ÇåƒÇ—èoÇµÇ‹Ç∑ÅB
* Sprite.callÅiÇ±ÇÍÇÕîºåa* 2ÅAîºåa* 2ÅjÅB
*
...
(function() {
    ...
    enchant.Core = enchant.Class.create(enchant.EventTarget, {
         ...
         * @name enchant.Core
         * @class
         * A class for controlling the core‚Äôs main loop and scenes.
         *
...
enchant.Node = enchant.Class.create(enchant.EventTarget, {
    ...
    initialize: function() {
        ...
        // Node„ÅåÁîüÊàê„Åï„Çå„ÇãÈöõ„Å´, tl „Éó„É≠„Éë„ÉÜ„Ç£„Å´ Timeline „Ç™„Éñ„Ç∏„Çß„ÇØ„Éà„ÇíËøΩÂä†„Åó„Å¶„ÅÑ„Çã.
...
enchant.DOMSound = enchant.Class.create(enchant.EventTarget, {
    ...
    /**
     * Volume. 0 (muted) ÔΩû 1 (full volume).
     * @type Number
     */
    volume: {
        get: function() {
