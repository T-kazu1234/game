...
enchant.ui.Button.DEFAULT_THEME = {
    ...
    B_button: {
        normal: {
            color: 'rgb(54, 54, 54)', 
            background: { type: 'radial-gradient', start: 'rgb(255, 210, 32)  60%', end: 'rgb(255, 210, 32) 100%' },
    ...
    A_button: {
        normal: {
            ...
            background: { type: 'radial-gradient', start: 'rgb(256, 0, 0)  60%', end: 'rgb(256, 0, 0) 100%' },
            border: { color: '#026', radius: '50%'  , width: 1, type: 'solid' },//ボーダ（境界線）を太くすると立体感が出る
            textShadow: { offsetX: 0, offsetY: 1, blur: 0, color: '#666' },
            boxShadow: { offsetX: 0, offsetY: 1, blur: 0, color: 'rgba(0, 0, 0, 0.5)' }
        },
    ...
    X_button: {
        normal: {
            color: 'rgb(255, 255, 255)', 
            background: { type: 'radial-gradient', start: 'rgb(0, 0, 255)  60%', end: 'rgb(0, 0, 255) 100%' },
            border: { color: '#026', radius: '50%'  , width: 1, type: 'solid' },//ボーダ（境界線）を太くすると立体感が出る
            textShadow: { offsetX: 0, offsetY: 1, blur: 0, color: '#666' },
            boxShadow: { offsetX: 0, offsetY: 1, blur: 0, color: 'rgba(0, 0, 0, 0.5)' }
        },
